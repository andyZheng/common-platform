    ...
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                Inventory inv = new Inventory(i + "My Inventory");
                Product product = new Product(i + "Sony Discman", "A standard discman from Sony", 200.00);
                inv.getProducts().add(product);
                Book book = new Book(i + "Lord of the Rings by Tolkien", "The classic story", 49.99, "JRR Tolkien", 
