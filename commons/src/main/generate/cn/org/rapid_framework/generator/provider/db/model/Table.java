...
public class Table {
	...
	public String getClassName() {
		String underscoreName = StringHelper.toUnderscoreName(getSqlName());
		// TODO 过滤表名前缀 eg.tbl_user_info表生成的实体类为UserInfo
		String tablePrefix = GeneratorProperties.getNullIfBlank("tablePrefix");
		if (null != tablePrefix) {
		    underscoreName = underscoreName.replaceFirst(tablePrefix, "");
		}
		
        String defaultValue = StringHelper.makeAllWordFirstLetterUpperCase(underscoreName);
